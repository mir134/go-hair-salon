  ...
  >
    <template #header>
      <div class="recent-card__head">
        <span class="recent-card__title">最近充值</span>
...
import { RECHARGE_STATUS_LABELS, RECHARGE_STATUS_TAG_TYPES } from '@/constants'
import { formatCents, formatDateTime } from '@/utils/format'

// 最近充值（07-UI.md:78）：来自 /dashboard/summary 的最近 10 条充值记录，独立于日期范围。
// 实付与赠送分列展示，禁止把赠送计入客户实付（07-UI.md:74）。
defineProps<{
  items: Recharge[]
  loading: boolean
}>()
